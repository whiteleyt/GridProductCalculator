    ...
    public class RightAdjacentGridIntegersTest
    {
        ...
        public void Should_return_all_right_adjacent_integers_When_iterated()
        {
            var grid = new Grid(new int[][]
           {
            ...
            var actualAdjacentValues = new RightAdjacentGridIntegers(grid, 2).ToArray();

            AssertEx.AreEqual(expectedAdjacentValues, actualAdjacentValues);
        }

        [TestMethod]
        public void Should_return_all_right_adjacent_integers_When_iterated_with_max_width()
        {
            var grid = new Grid(new int[][]
           {
                new int[] { 1, 2, 3 },
            ...
            var actualAdjacentValues = new RightAdjacentGridIntegers(grid, 3).ToArray();

            AssertEx.AreEqual(expectedAdjacentValues, actualAdjacentValues);
        }

        [TestMethod]
        public void Should_return_all_right_adjacent_integers_When_iterated_with_min_width()
        {
            var grid = new Grid(new int[][]
           {
                new int[] { 1, 2 },
            ...
            var actualAdjacentValues = new RightAdjacentGridIntegers(grid, 1).ToArray();
        ...
        public void Should_error_When_constructor_supplied_with_null()
        {
            AssertEx.AssertThrows<ArgumentNullException>(
             () => new RightAdjacentGridIntegers(null, 2),
        ...
        public void Should_error_When_adjacent_integers_is_less_than_one()
        {
            ...
            AssertEx.AssertThrows<ArgumentException>(
             () => new RightAdjacentGridIntegers(grid, 0),
        ...
        public void Should_error_When_adjacent_integers_greater_than_maxX()
        {
            ...
            AssertEx.AssertThrows<ArgumentException>(
             () => new RightAdjacentGridIntegers(grid, 1),
